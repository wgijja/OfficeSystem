            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <#if (imageList?size>0) >
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" style="height: 400px;width: 400px"/></span>
                        </#if>
                    </div>
                    <!--下方的缩略图-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            <dt>
                                <div class="fl title"><i>${spec.attributeName}</i></div>
                            </dt>
                            <#list spec.attributeValue as option>
                            <dd>
                                <a href="javascript:;" class="{{isSelected('${spec.attributeName}','${option}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${option}')">${option}<span title="点击取消选择">&nbsp;</span></a>
                            </dd>
                            </#list>
                        </dl>
                        </#list>
